...
) ENGINE = InnoDB AUTO_INCREMENT = 2120011779 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `exam_answers` VALUES (-367259646, -2116198399, 2, '不会写呀这', '2024-11-29 12:18:38', 1.00);
...
INSERT INTO `exam_answers` VALUES (5, 1, 3, '选择 A, C', '2024-11-28 20:23:15', 30.00);
INSERT INTO `exam_answers` VALUES (249368578, -2116198399, 1, 'return ans.sort(ans.begin,ans.end);', '2024-11-28 22:39:00', 60.00);
